/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9fdf342985e73110ddd49219fa71c257)
...
interface __BaseEnv_CloudflareBindings {
	...
	GOOGLE_USER_TO_IMPERSONATE: "justin@126colby.com";
	WORKERS_AI_MODEL: "@cf/moonshotai/kimi-k2.6";
	DOC_ASSISTANT: DurableObjectNamespace<import("./src/index").DocAssistant>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DocAssistant";
	}
